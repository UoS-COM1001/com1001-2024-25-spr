...
|-:|-|-|-|-|
|1     | **Foundations**<ul><li>Web servers and HTTP</li><li>An Introduction to Sinatra</li><li>Controllers</li><li>Views</li><li>Queries</li></ul>| Starting to Develope Your Team Web Application <br /> Coding Challenges| | |
|2     | **Forms & Sesssions**<ul><li>Forms &mdash; the basics</li><li>Sanitisation & Validation</li><li>GET and POST</li><li>Sessions</li></ul> | Incorporating Queries and Forms <br /> Coding Challenges | | |
