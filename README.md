...
|3     | **Databases**<ul><li>[Databases](slides/3-1-databases.pdf)</li><li>[Object Relational Mapping](slides/3-2-orm.pdf)</li><li>[Data Confidentiality](slides/3-1-databases.pdf)</ul> | <ul><li>Creating a Database and a Set of Models for Your Application</li><li>Coding Challenge</li></ul> | Sprint 1 | |
